...
* durch Verknüpfung mit einer <<Preiskalkulationen, Preiskalkulation>>.
...
Preiskalkulationen gehören zu den zentral gespeicherten <<Die plentymarkets Artikelstruktur, Systemeinstellungen>>.
...
* Der Einkaufspreis
* Ein bestehender <<Was sind Verkaufspreise?, Verkaufspreis>>
...
Herstellerdaten werden <<Die plentymarkets Artikelstruktur, zentral in den plentymarkets Einstellungen>> verwaltet und anschließend mit Artikeln verknüpft.
...
* <<Preise, Preise>> funktionieren genauso wie bei normalen Artikeln. Verkäufer werden allerdings empfohlen, die Vererbungsfunktion zu deaktivieren und stattdessen für jede Variante einen eigenen Preis zu speichern.
