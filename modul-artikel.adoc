...
Einerseits können Anwender Artikel- und Variantendaten link:https://knowledge.plentyone.com/de-de/manual/main/artikel/neue-artikel.html[manuell in PlentyONE erstellen^].
Andererseits können sie auch Daten zwischen ihrem PlentyONE System und anderen, externen Systeme austauschen.
Hierfür stehen link:https://knowledge.plentyone.com/de-de/manual/main/artikel/import-export-anlage.html[unterschiedliche Tools^] zur Verfügung.
Anwender können Artikeldatensätze z.B.:

* link:https://knowledge.plentyone.com/de-de/manual/main/maerkte/ebay-einrichten.html#11000[aus vorhandenen eBay-Listings importieren^].
* link:https://knowledge.plentyone.com/de-de/manual/main/daten/ElasticSync.html[in CSV-Dateien pflegen und anschließend importieren^].
* link:https://knowledge.plentyone.com/de-de/manual/main/daten/rest-api.html[aus externen Systemen mit der REST-API importieren^].
* link:https://knowledge.plentyone.com/de-de/manual/main/artikel/export.html[aus ihrem PlentyONE System exportieren^].
...
Mit Hilfe der link:https://knowledge.plentyone.com/de-de/manual/main/artikel/aenderungen.html[Änderungshistorie^] können Anwender Änderungen an rechnungsrelevanten Daten verfolgen. Zum Beispiel können Anwender den gesamten Lebensweg eines Artikels oder eines Auftrags nachvollziehen.
...
Zu diesem Zweck können Anwender diverse link:https://knowledge.plentyone.com/de-de/manual/main/daten/FormatDesigner.html[Artikel- und Variantendaten exportieren^].
...
Verkaufspreise bestimmen also link:https://knowledge.plentyone.com/de-de/manual/main/artikel/preise.html[in welchen Situationen^] eine Variante zu einem bestimmten Preis verkauft wird.
...
* durch die manuelle link:https://knowledge.plentyone.com/de-de/manual/main/artikel/import-export-anlage-verzeichnis.html#240[Eingabe eines neuen Preises^].
...
* über die link:https://knowledge.plentyone.com/de-de/manual/main/artikel/massenbearbeitung.html#300[Varianten-Gruppenfunktion^].
* über die link:https://knowledge.plentyone.com/de-de/manual/main/artikel/massenbearbeitung.html#600[Stapelverarbeitung^].
* durch den link:https://knowledge.plentyone.com/de-de/manual/main/daten/ElasticSync.html[Import von Preisdaten^].
* per link:https://knowledge.plentyone.com/de-de/manual/main/daten/rest-api.html[REST-API^].
...
link:https://knowledge.plentyone.com/de-de/manual/main/artikel/preise.html#1000[Preiskalkulationen^] gehören zu den zentral gespeicherten <<#_einführung_in_die_plentymarkets_artikelstruktur, Systemeinstellungen>>.
...
* die link:https://knowledge.plentyone.com/de-de/manual/main/artikel/import-export-anlage-verzeichnis.html#240[manuelle Verknüpfung^] der Preiskalkulation mit einer Variation.
* den link:https://knowledge.plentyone.com/de-de/manual/main/daten/elasticSync-artikel.html#2300[Import^] von Preiskalkulationsverknüpfungen.
* die Verwendung der link:https://knowledge.plentyone.com/de-de/manual/main/artikel/massenbearbeitung.html#300[Varianten-Gruppenfunktion^].
...
* die Artikel einer bestimmten link:https://knowledge.plentyone.com/de-de/manual/main/artikel/kategorien.html#1530[Kategorie^] zu vergünstigen.
* bestimmte Zahlungsarten attraktiver zu machen.
* beschädigte Ware manuell link:https://knowledge.plentyone.com/de-de/manual/main/pos/pos-kassenbenutzer.html#140[an der Kasse im stationären Laden^] zu vergünstigen.
...
In PlentyONE können link:https://knowledge.plentyone.com/de-de/manual/main/artikel/kategorien.html[Kategorien^] sowohl im Sinne von _Warengruppen_ als auch im Sinne von den _Content-Seiten_ eines Webshops verstanden werden. In diesem Kapitel sind mit Kategorien Warengruppen gemeint. Sie dienen dazu, Produkte übersichtlich zu gruppieren.
...
link:https://knowledge.plentyone.com/de-de/manual/main/artikel/einheiten.html[Einheiten^] gehören zu den zentral gespeicherten <<#_einführung_in_die_plentymarkets_artikelstruktur, Systemeinstellungen>>. Sie dienen dazu:
...
link:https://knowledge.plentyone.com/de-de/manual/main/artikel/attribute.html[Attribute^] gehören zu den zentral gespeicherten <<#_einführung_in_die_plentymarkets_artikelstruktur, Systemeinstellungen>>. Sie dienen dazu:
...
Hierfür werden link:https://knowledge.plentyone.com/de-de/manual/main/artikel/eigenschaften.html[Eigenschaften und Merkmale] verwendet.
...
link:https://knowledge.plentyone.com/de-de/manual/main/artikel/personalisierte-artikel.html#verpflichtend-vorausgewaehlt[Eine mögliche Anwendung] ist zum Beispiel die Darstellung von Pfandbeträgen, bei denen keine Mehrwertsteuer angewendet wird.
...
link:https://knowledge.plentyone.com/de-de/manual/main/artikel/hersteller.html[Herstellerdaten] gehören zu den zentral gespeicherten <<#_einführung_in_die_plentymarkets_artikelstruktur, Systemeinstellungen>>.
...
Provisionen werden immer für eine bestimmte Kombination aus link:https://knowledge.plentyone.com/de-de/manual/main/webshop/mandanten-verwalten.html[Mandant^] und link:https://knowledge.plentyone.com/de-de/manual/main/auftraege/auftragsherkunft.html[Herkunft^] gespeichert.
...
|link:https://knowledge.plentyone.com/de-de/manual/main/artikel/multipacks-pakete-sets-verwalten.html#1000[Multipack^]
...
|link:https://knowledge.plentyone.com/de-de/manual/main/artikel/multipacks-pakete-sets-verwalten.html#2000[Paket^]
...
|link:https://knowledge.plentyone.com/de-de/manual/main/artikel/multipacks-pakete-sets-verwalten.html#3000[Set^]
...
Anwender können eine link:https://knowledge.plentyone.com/de-de/manual/main/daten/backup.html[Backup-Funktion^] nutzen, um Artikel- und Variantendaten in der Datenbank auf einen früheren Stand zurückzusetzen oder um gelöschte Daten wiederherzustellen.
