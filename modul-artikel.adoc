...
Das heißt, dass Händler ihre Produktdaten im plentymarkets-ERP-System einpflegen.
...
Müssen Daten, wie z.B. die Beschreibung oder der Preis eines Artikels, zu einem späteren Zeitpunkt geändert werden, muss der Händler diese Daten lediglich zentral im plentymarkets-ERP-System ändern.
...
Einerseits können Anwender Artikel- und Variantendaten link:https://knowledge.plentymarkets.com/de-de/manual/main/artikel/neue-artikel.html[manuell in plentymarkets erstellen^].
Andererseits können sie auch Daten zwischen ihrem plentymarkets-System und anderen, externen Systeme austauschen.
...
* link:https://knowledge.plentymarkets.com/de-de/manual/main/artikel/export.html[aus ihrem plentymarkets-System exportieren^].
...
In plentymarkets wird zwischen Verkaufspreisen und Preisen unterschieden.
...
In plentymarkets ist es auch möglich, Produkte zu charakterisieren, ohne dabei Varianten zu bilden.
