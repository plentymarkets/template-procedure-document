...
Der Anwender hat zum einen die Möglichkeit, alle E-Mail-Vorlagen, die er an einen bestimmten Kunden gesendet hat, einzusehen. Voraussetzung dafür ist, dass die E-Mail-Vorlagen mit einer eindeutigen Kontakt-ID verknüpft sind.
