...
Weitere Informationen zum EmailBuilder sind im Handbuch auf der Seite link:https://knowledge.plentyone.com/de-de/manual/main/crm/emailbuilder.html[EmailBuilder^] zu finden.
...
Weitere Informationen zu Ereignisaktionen sind im Handbuch auf der Seite link:https://knowledge.plentyone.com/de-de/manual/main/automatisierung/ereignisaktionen.html[Ereignisaktionen^] zu finden.
