...
Ab 21.08.2018 können Artikel im Menü *Artikel » Artikel bearbeiten » Artikel öffnen* von Rabatten an der plentymarkets POS Kasse ausgeschlossen werden. Das bedeutet, dass Kassenpersonal keinen manuellen Rabatt eingeben kann. Auch Kundenklassenrabatte greifen für diese nicht rabattfähigen Artikel nicht.
