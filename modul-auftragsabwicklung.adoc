...
_Wichtig_: Auftragsdokumente unterliegen einer *Aufbewahrungspflicht*. Die Aufbewahrung von sowie der Umgang mit den Dokumenten liegt in der Verantwortung des Anwenders. +
Erstellte Dokumente und Belege für einen Auftrag sind im Backend im Tab *Belege* des jeweiligen Auftrages zu finden. Die Erstellung eines Dokumentes kann nicht rückgängig gemacht werden. Gelöscht werden können nur externe Dokumente. Erstellte Dokumente können im Tab *Belege* archiviert werden und sind dann im untergeordneten Tab *Archivierte Dokumente* zu finden. Auch hier können die erstellten Belege nicht gelöscht werden.
