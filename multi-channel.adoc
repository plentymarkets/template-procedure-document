...
|grosshandel.eu|*Hinweis:* Die Schnittstelle wird von grosshandel.eu überarbeitet und kann momentan nicht genutzt werden.
|Hood|[_Ja/Nein_]
...
|Pixmania|[_Ja/Nein_]
|real.de|[_Ja/Nein_]
|Restposten.de|*Hinweis:* Die Schnittstelle wird von Restposten.de überarbeitet und kann momentan nicht genutzt werden.
...
Bei vielen Marktplätzen können zudem über link:https://knowledge.plentymarkets.com/automatisierung/ereignisaktionen[Ereignisaktionen^] automatisch Informationen zu Versandbestätigungen, Stronierungen, Retouren etc. an die Schnittstelle gesendet werden.
