...
legend
Automatisierung
|_ PlentyONE Flow Studio
|_ Prozesse
|_ PlentyONE Flow Tracker
end legend
----
...
|_ Frei definierbare Felder
  |_ Bearbeiten
|_ Katalog-Vorlagen hinzufügen
  |_ Bearbeiten
|_ Berichte
  |_ Verarbeitungsstatus
    |_ Verarbeitungssattus
    |_ Herunterladen  
|_ Einstellungen
  |_ Bearbeiten
end legend
...
legend
Abonnement
|_ Gruppenfunktion (Abonnement-UI)
  |_ Versandkosten
  |_ Versandprofil
  |_ Status
  |_ Tags
...
legend
Amazon
|_ Marktplatz-Bestandsinformationen
  |_ Konfigurieren
  |_ Rohdaten anzeigen
end legend
----
