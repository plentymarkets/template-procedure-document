...
Es handelt sich dann um einen link:https://knowledge.plentyone.com/de-de/manual/main/auftraege/gutscheine.html[Gutschein^], wenn der Inhaber diesen zur Einlösung gegen Gegenstände oder Dienstleistungen verwenden kann.
...
* werbliche Aktionen durchzuführen, z.B. 20% auf alle Produkte. Solche Aktionen werden mit sogenannten link:https://knowledge.plentyone.com/de-de/manual/main/auftraege/gutscheine.html[Aktionsgutscheinen^] durchgeführt.

PlentyONE Händler können Bestandskunden einen anderen Preis anbieten als Standardkunden. Solche Rabatte hängen von der link:https://knowledge.plentyone.com/de-de/manual/main/crm/vorbereitende-einstellungen.html#kundenklasse-erstellen[Kundenklasse^] des Bestandskunden ab, und davon, ob für diese Kundenklasse ein link:https://knowledge.plentyone.com/de-de/manual/main/crm/vorbereitende-einstellungen.html#rabattsystem-nutzen[Rabatt^] im ERP-System PlentyONE gespeichert ist.
