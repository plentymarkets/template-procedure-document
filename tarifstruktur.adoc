...
Um eine bestimmte Kennzahl auszulesen, werden Rohdaten benötigt. Die verfügbaren Rohdaten sind je nach Produkt beschränkt. Weitere Informationen sind auf der Handbuchseite link:https://knowledge.plentymarkets.com/business-entscheidungen/business-intelligence/reports/reports-verwalten#_datenformat_creator[Reports verwalten^] zu finden.
