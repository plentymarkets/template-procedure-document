...
Einlagen und Entnahmen sind im <<#_verfahren_bei_ausfall_von_plentypos, Online-Modus>> von plentyPOS, also mit bestehender Verbindung zum ERP-System plentymarkets, als auch im Offline-Modus möglich. Im Online-Modus werden die Daten werden direkt an das ERP-System plentymarkets übertragen und nicht auf dem mobilen Endgerät zwischengespeichert. Im Offline-Modus, also wenn keine Verbindung zum ERP-System plentymarkets besteht, werden die Daten vorübergehend auf dem mobilen Endgerät zwischengespeichert und bei der nächsten Verbindungsherstellung zum System synchronisiert.
