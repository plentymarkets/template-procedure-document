...
<<#_speicherung_und_abrufbarkeit_von_plentymarkets_pos_berichten, Umfangreiche Berichtsoptionen>> ermöglichen außerdem eine detaillierte Visualisierung der Kassenvorgänge.
...
Diese Daten werden auf dem mobilen Endgerät zwischengespeichert, um die <<#_verfahren_bei_ ausfall_von_plentymarkets_pos, Ausfallsicherheit>> zu gewährleisten. Nach Abschluss des Auftrags können diese Daten nicht mehr geändert werden.
...
Einlagen und Entnahmen sind nur möglich, wenn plentymarkets POS im <<#_verfahren_bei_ausfall_von_plentymarkets_pos, Online-Modus>> läuft, also eine Verbindung zum ERP-System plentymarkets besteht. Die Daten werden also direkt an das ERP-System plentymarkets übertragen und nicht auf dem mobilen Endgerät zwischengespeichert.
