...
|*Betrag*
|Brutto-Betrag des Vorgangs ./. Gutscheinverkäufe
|
...
|Belegnummer
|Filterung nach einer Belegnummer (bei Eingabe einer Belegnummer) oder nach einer Abfolge von Belegnummern (bei Eingabe eines Bereichs)
...
Barzahlung, EC-Karte, über Plugin eingebundene Zahlungsarten

|Zeitraum
|Filterung nach dem Zeitpunkt des Geschäftsvorfalls. Folgende Zeiträume sind verfügbar: +
Aktueller Monat, Letzter Monat, Letzte 30 Tage, Letzte 3 Monate, Letzte 6 Monate, Letzte 12 Monate, Letztes Jahr, Letztes Quartal, freie Datumsauswahl

|Typ
|Filterung nach Typ des Geschäftsvorfalls. Folgende Typen sind verfügbar: +
Auftrag, Einlage, Entnahme, Stornierung, Retoure, Gutschrift, Startbeleg, Endbeleg, Tagesabschluss
|===
...
|Auflistung der Benutzer seit dem letzten Tagesabschluss inkl. des erwirtschafteten Umsatzes
|====
