 ...
 * __l__*_astReceipt _*-> Die Nummer des letzten Beleges, der im Tagesabschluss berücksichtigt wurde.
...
* *_token _*->__ __Das Token des Exportes
* *_state _*_-> _Der Status des Exports (z.B. in Arbeit oder Fertig)
