...
Systemseitig werden die Kassendaten in der Tabelle *plenty_pos_base* und dort in den folgenden Tabellen gespeichert:
 ...
 * *_currentCashBalanceValue_* -> Der Barbestand der Kasse, der zum aktuellen Zeitpunkt bekannt ist. Bei Offline-Betrieb kann dieser Bestand vom physischen Kassenbestand abweichen, bis alle Aufträge in das ERP-System plentymarkets importiert wurden.
 * *_currentReceiptNumber_* -> Die aktuell bekannte Anzahl der erstellten Belege. Bei Offline-Betrieb kann diese Anzahl von der Anzahl in der Kasse abweichen, bis alle Aufträge in das ERP-System plentymarkets importiert wurden.
