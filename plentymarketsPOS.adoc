= Vorlage zur Verfahrensdokumentation für plentymarkets POS
:lang: de
...
- Sind externe EC-Kartenterminals/Zahlungsdienstleister im Einsatz?
- Werden Kartenterminals über Plugins an die Kasse angebunden? Wenn ja, welche Änderungen der hier beschriebenen Verfahren ergeben sich aus diesen Anbindungen?
