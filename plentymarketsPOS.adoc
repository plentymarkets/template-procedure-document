...
Die folgenden Arten von Geschäftsvorfällen können über plentymarkets POS erstellt und im ERP-System plentymarkets gespeichert und archiviert werden:
...
// Wie wird dokumentiert, dass/wer den Preis geändert wurde?
...
Die Daten einer Stornierung mit der Herkunft POS werden im ERP-System plentymarkets wie folgt gespeichert:
...
* Geschäftsvorfall im Kassenjournal
* Beleg im Dokumentenarchiv
* Auftrag des Typs “Retoure” im Auftragsmodul
* Tab “Aufträge” des Kunden
* Daten für den IDEA-Export
...
Bonierter Betrag, Mengen und WErtangaben

*_Welche Daten sind unveränderbar?_*
...
=== Speicherung von POS Geschäftsvorfällen
...
Zwischenberichte sind kein gültiger Nachweis gegenüber dem Finanzamt und werden daher weder in der plentymarkets App noch im ERP-System plentymarkets gespeichert.

Im Unternehmen wird mit den Ausdrucken von Zwischenberichten wie folgt verfahren:

* [ _Beschreibung einfügen_ ]

==== Tagesberichte (Z-Berichte)

Tagesbereichte sind GoBD-relevante Dokumente. Tagesberichte werden in plentymarkets POS fortlaufend nummeriert, um die Vollständigkeit zu gewährleisten.
...
* ID (fortlaufende Nummer des Tagesbelegs)
...
Tagesberichte werden in plentymarkets POS erstellt und automatisch an das ERP-System plentymarkets übertragen. Tagesberichte können im Menü *Aufträge » Dokumentenarchiv* aufgerufen werden. Dort werden sie als Dokumente des Typs “Z-Report” gespeichert.
...
In plentymarkets POS ist jederzeit kassensturzfähig. Es ist also jederzeit möglich, den Soll-Bestand laut Kassenjournal mit dem Ist-Bestand der Kasse zu vergleichen. Zu diesem Zweck werden die in der Kasse vorhandenen Geldscheine und Münzen physisch gezählt und ein Zählprotokoll erstellt. In plentymarkets POS kann entweder die Anzahl der einzelnen Münzen und Geldscheine oder das Ergebnis der Zählung als Gesamtbetrag eingeben werden.
...
Alle plentymarkets POS Geschäftsvorfälle können über das Menü *Aufträge » POS » IDEA-Export *des ERP-Systems plentymarkets in elektronisch auswertbarer Form exportiert werden. Der Export erfolgt pro Kalenderjahr ohne weitere Filterungen. Es werden also alle Geschäftsvorfälle von allen plentymarkets POS Kassen in den Export übernommen. Benutzer, die den Export durchführen, können also nur das Kalenderjahr, jedoch nicht den Umfang der exportierten Daten beeinflussen. Der Datenexport erfolgt im GDPdU-konformen IDEA-Format und wurde durch die Audicon GmbH zertifiziert.
...
Das Handbuch der ERP-Lösung plentymarkets stellt eine Anleitung zur Erstellung des IDEA-Exports bereit: https://knowledge.plentymarkets.com/omni-channel/pos/pos-einrichten#500[https://knowledge.plentymarkets.com/omni-channel/pos/pos-einrichten#500]
