...
plentymarkets POS ist ein Modul der plentymarkets App, das für den stationären Verkauf von Waren und/oder Dienstleistung entwickelt wurde. plentymarkets POS ist ein mobiles, App-basiertes Registrierkassensystem des Typs 3 (EDV-Registrierkassen). Im Sinne der GoBD ist plentymarkets POS als Kassensystem ein Vorsystem der elektronischen Buchhaltung.
...
|Belegnummer|Filterung nach einer Belegnummer (Eingabe einer Belegnummer) oder nach einer Abfolge von Belegnummern (Eingabe eines Bereichs).
...
* Letzter Beleg (letzter Beleg des Berichts)
* Zeitraum (von / bis)
* Barbestand
