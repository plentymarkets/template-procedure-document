...
Alle Informationen zum Newsletter-Versand sind im Handbuch auf der Seite https://knowledge.plentyone.com/de-de/manual/main/crm/newsletter-versenden.html[Newsletter^] zu finden.
