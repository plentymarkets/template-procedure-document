...
Weitere Informationen sind im Handbuch auf den Seiten link:https://knowledge.plentymarkets.com/daten/daten-importieren/ElasticSync[Import-Tool nutzen^] und link:https://knowledge.plentymarkets.com/daten/daten-exportieren/FormatDesigner[FormatDesigner^] zu finden.
