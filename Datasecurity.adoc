...
Gespeichert. Der Zugriff eines Kundensystems ist nur auf die dazugehörige Kundenbuckets möglich. Ein Zugriff auf ein „fremdes“ Kundenbuckets ist aufgrund der Struktur und Rechtevergabe nicht möglich.
