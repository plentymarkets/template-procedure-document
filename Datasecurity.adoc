...
===== Systemdaten
Die Speicherung systembezogener Daten eines plentymarkets Kundensystems erfolgt in einer eigenen Datenbank. Hier werden z.B. Daten gespeichert wie:
...
=== Welche Daten werden wie gespeichert?
Die Speicherung der Daten eines plentymarkets Kundensystems erfolgt u.a. auf Amazon S3-Servern. Hier werden z. B. Daten gespeichert wie:
...
Im Anschluss werden alle Systemdaten auf den Backup-Servern gesichert, und im Anschluss von den Produktiv-Servern gelöscht. Die gesicherten Daten werden weitere 30 Tage aufbewahrt und anschließend endgültig gelöscht. Dabei findet keine sichere Löschung der Daten statt. Allerdings wird der freigewordenen Speicherplatz sofort mit neuen Daten überschrieben, sodass Systemdaten nicht wiederhergestellt werden können.
...
image::workspace/template_procedure_document/assets/AWS-EntwurfV4.graffle.jpg[]

=== Serverstandorte AWS Cloud

==== Neusysteme
Für Neukunden stehen die Standorte “Amazon Frankfurt” sowie “Amazon Dublin” zur Auswahl.
