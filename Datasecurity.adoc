...
Im Anschluss werden alle Systemdaten auf den Backup-Servern gesichert, und im Anschluss von den Produktiv-Servern gelöscht. Die gesicherten Daten werden weitere 30 Tage aufbewahrt und anschließend endgültig gelöscht.
