...
Die Auftragsabwicklung als ein Modul von plentymarkets erlaubt die zentrale Bearbeitung und Abwicklung von Aufträgen, die aus verschiedenen Kanälen stammen. Dabei unterscheidet plentymarkets zwischen verschiedenen Auftragstypen und verschiedenen Auftragsherkünften. Die Auftragsherkünfte dienen dazu, zu kennzeichnen, über welchen Kanal ein Auftrag generiert wurde. Die Auftragstypen dienen dazu, verschiedene Geschäftsvorfälle abzubilden. Beide Aspekte werden in den folgenden Abschnitten erläutert.
...
Folgende Systemherkünfte sind standardmäßig in jedem plentymarkets System vorangelegt:
...
|108.02|Otto Direktversand|Auftrag|||
|109.00|Shopgate|Auftrag|26.10.2012||
|110.00|Allyouneed|Auftrag|26.10.2012|01.12.2008|früher MeinPaket
...
|144.00|DaWanda|Auftrag|13.10.2014|31.08.2018|
...
|108.02|Otto Cooperation|Auftrag|||
 ...
 * kein Eingabefeld für ein Versanddatum
 * kein Eingabefeld für ein Rückgabedatum
 * kein Eingabefeld für die Paketanzahl
 * kein Eingabefeld für Paketnummern
 ...
 * Änder des Zahlungsziels
 * Ändern des Versanddienstleisters
 * Ändern des Versandprofils
 * Ändern der externen Auftragsnummer
 * Ändernd des Zeichens des Kunden
 * Ändern der Anzahl der Pakete
 * Ändern der Paketnummern
...
In einem Sammelauftrag können folgende Dokumente erstellt werden: Beim Auftragstyp Sammelauftrag ist die erzeugte Rechnung anders aufgebaut. Die Artikelbezeichnung enthält hier Ursprungsdaten wie Name, ID, Auftragsdatum und Gesamtwert.

 * Sammelrechnung und
 * Mahnung.


Beim Auftragstyp Sammelauftrag ist die erzeugte Rechnung anders aufgebaut. Die Artikelbezeichnung enthält hier Ursprungsdaten wie Name, ID, Auftragsdatum und Gesamtwert.
|===
|Dokument|Bearbeitungsmöglichkeiten

|Sammelrechnung|Nach dem Erzeugen sind viele Bearbeitungsmöglichkeiten gesperrt.
