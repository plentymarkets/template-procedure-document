...
=== Recovery
Kunden haben die Möglichkeit, link:https://knowledge.plentyone.com/de-de/manual/main/daten/backup.html[Backups^] selbstständig im Menü *Einrichtung » Einstellungen » Hosting » Backup* wieder einzuspielen. Bei Bedarf spielt die Administration Backups oder Teile von Backups wieder ein.
