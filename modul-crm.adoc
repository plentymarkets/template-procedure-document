...
* die Art, wie sich der Kontakt registriert hat; d.h. regulärer Zugang oder Gastzugang (siehe Kapitel <<regulaerer_zugang_und_gastzugang, Regulärer Zugang und Gastzugang>>)
...
Bei regulären Zugängen wird die Anzahl der Aufträge summiert. Die Summe der Aufträge ist dann z.B. auch in der Kontaktübersicht zu sehen (siehe <<bild-uebersicht-kontaktdatensaetze>> in Kapitel <<kontakt_ids, Kontakt-IDs>>).
