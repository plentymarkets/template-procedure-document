...
Weitere Informationen zu Ereignisaktionen sind im plentymarkets Handbuch auf der Seite link:https://knowledge.plentymarkets.com/basics/automatisierung/ereignisaktionen[*Ereignisaktionen*, window="_blank"] zu finden.
