...
Der Anwender kann den im System integrierten Newsletter-Dienst nutzen oder seine Newsletter über die externen Anbieter Newsletter2Go und CleverReach versenden. Generell besteht die Möglichkeit, Newsletter-Anbieter über ein Plugin anzubinden. Weitere Informationen zu Plugins sind auf dem link:https://marketplace.plentymarkets.com[plentyMarketplace, window="blank"] zu finden.
