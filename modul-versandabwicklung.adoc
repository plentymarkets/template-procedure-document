...
Weitere Informationen zu den Einstellungen im Versandprofil sind im Handbuch auf der Seite link:https://knowledge.plentyone.com/de-de/manual/main/fulfillment/versand-vorbereiten.html[Versand vorbereiten^] zu finden.
